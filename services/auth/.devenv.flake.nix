{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/ivnxptrv/ft_transcendence/services/auth";
  project_input_ref = "path:/home/ivnxptrv/ft_transcendence/services/auth";
  devenv_dotfile = "/home/ivnxptrv/ft_transcendence/services/auth/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000/";
  devenv_runtime = "/run/user/1000/devenv-963303f";
  ...
  hostname = "frutro";
  username = "ivnxptrv";
  git_root = "/home/ivnxptrv/ft_transcendence";
  secretspec = null;
};
    in
    {
