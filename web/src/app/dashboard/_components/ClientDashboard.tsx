  ...
  return (
    <div style={{ background: '#0f0f0f', minHeight: '100vh', color: '#e4e4e4' }}>
      ...
      <div className="px-4 pt-6 pb-8 max-w-2xl mx-auto">
        <p style={{ fontSize: 10, color: '#444', letterSpacing: '0.12em' }} className="font-medium uppercase mb-0.5">
          Client
        </p>
          ...
          {orders.map(order => (
            ...
            >
              <div className="flex items-start gap-2.5 mb-2.5">
                <p style={{ fontSize: 13, color: '#ccc', lineHeight: 1.5 }} className="flex-1 line-clamp-2">
                  {order.clientQuery}
                </p>
                <span
