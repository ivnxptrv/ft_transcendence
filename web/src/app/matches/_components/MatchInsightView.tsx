  ...
  return (
    <section className="flex flex-col gap-6">
      ...
      >
        {paid
          ? price !== undefined
            ? `Unlocked — $${price} is in your wallet.`
            : "Unlocked — your earnings are in your wallet."
          : price !== undefined
            ? `You'll earn $${price} when the client unlocks it.`
            : "You'll earn your price when the client unlocks it."}
      </p>
