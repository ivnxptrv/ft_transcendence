      ...
      <main className="px-6 pt-12 pb-24 max-w-2xl mx-auto">
        ...
        <section>
              ...
              <SettingsRow
                ...
                right={
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] underline underline-offset-4 font-bold border-l border-white/10 pl-3 ml-1 uppercase tracking-tighter">
                      Copy
                    </span>
                  </div>
                }
          ...
          <SettingsGroup
            isClient={isClient}
            rows={[
              <SettingsRow key="signout" label="Sign out of Vekko" danger isClient={isClient} />,
            ]}
          />
        </section>
      </main>
