...
// Create-or-view. Insider with no legend → create form (+ nudge dot). Insider
// with a legend → read-only view (no edit, no resubmit — legend is set once).
