  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-2.5 mb-2.5">
        <p
          style={{ fontSize: 13, color: "#888", lineHeight: 1.5, fontStyle: "italic" }}
          className="flex-1"
        >
          {card.insiderLegend}
        </p>
      ...
      <div className="flex items-center justify-between">
        ...
        {card.isUnlocked ? (
          <span
            style={{ fontSize: 10, background: "#1e2e18", color: "#4a9e5a", borderRadius: 20 }}
          ...
          <button
            style={{ fontSize: 11, background: "#e4e4e4", color: "#0f0f0f", borderRadius: 20 }}
...
export default async function OrderDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div style={{ background: "#0f0f0f", minHeight: "100vh" }}>
      <nav
        style={{ background: "#0f0f0f", borderBottom: "0.5px solid #1f1f1f" }}
      ...
      <div className="px-4 pt-5 pb-8 max-w-2xl mx-auto">
        ...
        <p
          style={{ fontSize: 11, color: "#444", letterSpacing: "0.1em" }}
