...
export const MOCK_ORDERS: Order[] = [
    {
        id: 'ord_001',
        clientQuery: 'What is it actually like to quit a stable job and go freelance in Bangkok? Not the blog-post version.',
...
export const MOCK_RESPONSES: ResponseCard[] = [
    {
        id: 'resp_001',
        orderId: 'ord_001',
        insiderLegend: 'Freelance developer, 4 years in Bangkok after leaving a corporate role in Singapore.',
        price: 120,
...
export const MOCK_MATCHES: Match[] = [
    ...
    },
    {
        ...
        clientQuery: 'How do you deal with imposter syndrome when you\'ve been promoted into a leadership role you didn\'t expect?',
        matchScore: 0.87,
        status: 'responded',
    ...
    },
    {
        ...
        clientQuery: 'What does the early stage of starting a business in SEA actually look like — the admin, the loneliness, the doubt?',
        matchScore: 0.81,
        status: 'purchased',
    ...
    },
    {
        id: 'match_004',
        insiderId: 'insider_001',
        clientQuery: 'Realistic picture of dating as an expat in Bangkok — patterns, pitfalls, what nobody says publicly.',
        matchScore: 0.76,
        status: 'new',
