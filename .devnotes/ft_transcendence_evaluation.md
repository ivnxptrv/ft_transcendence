...
**Evaluate 5 students in this team**
...
Verify that **ALL team members (4-5 people)** are present for the evaluation. Each absent member will result in a **-10 point penalty** on the final grade.

**Are all team members present?** ☐ Yes ☐ No

If not all members are present, note the number of absent members and apply the appropriate penalty (-10 points per absent member).
...
**Can each team member clearly explain their role and contributions?** ☐ Yes ☐ No
...
**Is the README.md complete with all required sections?** ☐ Yes ☐ No
...
**Can different team members explain the project coherently?** ☐ Yes ☐ No
...
**Does the Git history show proper team collaboration?** ☐ Yes ☐ No
...
**All three components must be present and functional for the project to be considered complete.** ☐ Yes ☐ No
...
Open Chrome DevTools and verify the console. There should be no errors or warnings visible in the browser console. Minor warnings from third-party libraries may be acceptable if explained.
...
Test on at least two different screen sizes (desktop and mobile/tablet). The interface should adapt properly to different screen sizes and remain usable on both desktop and mobile devices.
...
The project must use a modern CSS framework or styling solution. Plain CSS alone is not sufficient.
...
Both client-side and server-side validation must be present. Server-side validation is critical for security.
...
Verify the connection is secure (check browser address bar). All communication between frontend and backend must be encrypted using HTTPS.
...
**Does the project claim at least 14 points from modules?** ☐ Yes ☐ No

The team must have selected modules totaling at least 14 points. This is verified in the README before testing the actual implementation.
...
**Are all claimed Major modules properly implemented and functional?** ☐ Yes ☐ No
...
**Are all claimed Minor modules properly implemented and functional?** ☐ Yes ☐ No
...
**Are custom modules properly justified and implemented?** ☐ Yes ☐ No

Custom modules must be substantial and demonstrate real technical skill. Trivial features or shortcuts will not be accepted.
...
Review some code files to assess organization. The code doesn't need to be perfect, but it should be organized and maintainable. Major code quality issues may indicate problems.
...
**Does the team demonstrate understanding of their project?** ☐ Yes ☐ No
...
**Does the project demonstrate effective team collaboration?** ☐ Yes ☐ No
...
Test the main features of the application. The application should be stable enough for a demonstration. Minor bugs are acceptable, but critical failures are not.
...
**Does the project reflect genuine effort and learning?** ☐ Yes ☐ No

This project is about learning and demonstrating skills. The project should show that the team invested effort and learned.
...
**Does the total of VALIDATED modules reach at least 14 points?** ☐ Yes ☐ No

> **CRITICAL:** Be fair but strict. Only count modules that actually work and meet the requirements specified in the subject PDF. If the project does not reach 14 points from validated modules, it fails.
...
**Would you consider this a successful group project?** ☐ Yes ☐ No
...
Evaluate the bonus part if, and only if, the mandatory part has been entirely and perfectly done, and error management handles unexpected or bad usage. In case all the mandatory points were not passed during defense, bonus points must be totally ignored.

Bonus points are awarded for modules beyond the required 14 points. Each additional validated module adds bonus points:

- **Major module** = 2 bonus points
- **Minor module** = 1 bonus point
...
Rate it from 0 (failed) through 5 (excellent): **4**
